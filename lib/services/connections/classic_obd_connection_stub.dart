// iOS stub - Classic Bluetooth not supported
import 'dart:async';
import 'obd_connection.dart';

/// Classic Bluetooth (SPP) - iOS stub
/// iOS does not support Classic Bluetooth SPP connections
class ClassicObdConnection implements ObdConnection {
  ...
  final ConnectionState _currentState = ConnectionState.disconnected;
