// iOS: Only BLE connection, no Classic Bluetooth
import 'dart:async';
...
/// iOS OBD Manager - BLE only, no Classic Bluetooth
/// Extends ObdManagerBase to provide a unified interface
class ObdManagerIos extends ObdManagerBase {
  ...
  @override
  Future<void> stopScan() async => await _scanner.stopScan();
